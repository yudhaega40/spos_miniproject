    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('simpan_edit_tag') }}">
                    @csrf

                    <!-- Name -->
                    <div>
                        <x-input-label for="name" :value="__('Tag Name')" />
                        <input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $tag->name }}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="desc" class="block mt-1 w-full p-3" rows="5" name="desc" required autocomplete="name">{{ $tag->desc }}</textarea>
