                    ...
                    <table class="w-full lg:table-fixed border-collapse border border-slate-400 break-words">
                        <thead>
                            <tr class="bg-slate-300">
                                <th class="border border-slate-400 text-center p-2 lg:w-4/12">Nama Tag</th>
                        ...
                        <tbody>
                            @foreach ($tag as $t)
                            <tr>
                                <td class="border border-slate-400 text-center p-2"><a href='/post_by_tag/{{$t->id}}' class="font-semibold hover:text-blue-900">{{ $t->name }}</a></td>
                                <td class="border border-slate-400 text-center p-2">{{ $t->desc }}</td>
